package com.goldpricecafe.mobile.skins
{
	...
	public class ButtonBarLastButton extends spark.skins.mobile.ButtonBarLastButtonSkin
	{
		...
		override protected function drawBackground(unscaledWidth:Number, unscaledHeight:Number):void {
			...
			if( currentState.indexOf("down") >= 0 ) {
				...
				myBorder.graphics.drawRoundRectComplex(0, 0, unscaledWidth, unscaledHeight, 0, cornerRadius, 0, cornerRadius );
